// Bellman-Ford Algorithm: A dynamic programming strategy for finding shortest paths.
// Note: Negative edge weights are allowed.
// It repeatedly relaxes all the edges for n-1 times (where n is the number of vertices).
